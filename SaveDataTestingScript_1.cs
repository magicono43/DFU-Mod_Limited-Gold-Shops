...
namespace SaveDataTestingScript1
{
    ...
    {
        public Dictionary<int, int> ShopBuildingData;

        /*public int BuildingKey;
        public int MapID; // Start adding my variables I think I will need and where I will need them. Such as BuildingID and MapID, also might have to put gold amount in different class? Or probably just save these values on transition or something, will have to do testing.
    ...
    public class SaveDataTestingScript1 : MonoBehaviour, IHasModSaveData
    {
        ...
        public static Dictionary<int, int> shopBuildingData;
        //public static Dictionary<int, int> shopBuildingData = new Dictionary<int, int>();
        ...
        public object NewSaveData()
        {
            ...
            {
                ShopBuildingData = new Dictionary<int, int>()
        ...
        public void RestoreSaveData(object saveData)
        {
            ...
            /*buildingKey = testingSaveData.BuildingKey;
            mapID = testingSaveData.MapID;
            currentGoldSupply = testingSaveData.CurrentGoldSupply;*/
        }
        ...
        {
            Debug.Log("You just made a spell ready, little bitch.");
            return;
        }
        ...
        void Start()
        {
            ...
            var tradeWindow = (DaggerfallTradeWindow)UIWindowFactory.GetInstanceWithArgs(UIWindowType.Trade, new object[] { uiManager, null, DaggerfallTradeWindow.WindowModes.Sell, null }); // "this" refers to the previous window. Replace it with null if you're not calling from a window.
        ...
        private static void Testing_OnTransitionInterior(PlayerEnterExit.TransitionEventArgs args)
        {
            ...
            if (GameManager.Instance.PlayerEnterExit.IsPlayerInsideOpenShop)
            {
                ...
                shopBuildingData.Add(buildingKey, currentGoldSupply);
                //shopBuildingData.Add(1, 1);
            }
            else
